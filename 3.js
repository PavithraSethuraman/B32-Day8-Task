class person {
    constructor(Name,Father_Name,Mother_Name,Husband_Name,Gender,Age,Address,Mobile_No,Email,Voter_ID,Aadhar_No) {
    this.Name = Name ;
    ...
    person_husband_name() {
        return `my husband name is ${this.Husband_Name}`;
        }
    person_gender() {
    ...
    //object
    const person_obj = new person("Pavithra Sethuraman","Shankar","Rajamani","SethuRaman",
    "F","29","no2_rajunagar_pudukottai","1234567891","pavisethu@gmail.com","147852369","125689723");
